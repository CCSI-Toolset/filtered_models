...
!<keyword category="Run Control" required="false" tfm="true">
!  <description>
!    Flag for subgrid cylinder-drag model.
!  </description>
!  <valid value=".FALSE." note="Do not use cylinder-drag subgrid model."/>
!  <valid value=".TRUE." note="Use cylinder-drag subgrid model. A. Sarkar, 
!    X. Sun S. Sundaresan, “Sub-grid drag models for horizontal cylinder arrays
!    immersed in gas-particle multiphase flows,” Chem. Eng. Sci., 104, 399-412
!    (2014)."/>
       SG_CYL_HYDRO = .FALSE.
!</keyword>
...
!<keyword category="Run Control" required="false" tfm="true">
!  <description>
!    Flag for subgrid cylinder-heat transfer model.
!  </description>
!  <valid value=".FALSE." note="Do not use cylinder-heat transfer subgrid
!    model."/>
!  <valid value=".TRUE." note="Use cylinder-heat transfer subgrid model."/>
       SG_CYL_ENERGY = .FALSE.
!</keyword>

!<keyword category="Run Control" required="false" tfm="true">
!  <description>
!    Cylinder diameter for cylinder sub-grid models.
!  </description>
!  <range min="0"/>
       SG_CYL_D = UNDEFINED
!</keyword>
...
!<keyword category="Run Control" required="false" tfm="true">
!  <description>
!    Cylinder spacing for cylinder sub-grid models.
!  </description>
!  <range min="1.41*SG_CYL_D"/>
       SG_CYL_a = UNDEFINED
!</keyword>

!<keyword category="Run Control" required="false" tfm="true">
!  <description>
!    Cylinder surface temperature for cylinder sub-grid models.
!  </description>
!  <range min="250"/>
       SG_CYL_T = UNDEFINED
!</keyword>
